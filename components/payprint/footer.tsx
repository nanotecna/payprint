        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              <a href="https://www.instagram.com/payprint.oficial/" aria-label="Instagram" className="text-blue-200 hover:text-white transition-colors">
              ...
              <a href="https://wa.me/553125666510" aria-label="WhatsApp" className="text-blue-200 hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/payprintgrafica" aria-label="LinkedIn" className="text-blue-200 hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
